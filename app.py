...
# Display similar movies for a given movie_id
movie_titles = dict(zip(movies['movieId'], movies['title']))
selected_movie_id = st.selectbox("Select a Movie ID to find similar movies", movies['movieId'].unique())
...
st.subheader(f"Movies similar to '{movie_titles[selected_movie_id]}' using Cosine Similarity:")
for i in similar_ids_cosine:
    st.write(movie_titles[i])

st.subheader(f"Movies similar to '{movie_titles[selected_movie_id]}' using Euclidean Distance:")
